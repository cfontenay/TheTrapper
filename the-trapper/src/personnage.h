...
struct Inventaire
{
    ...
    int caseSelectionnerBarrePlacement;         //va de zéro à trois
...
struct Personnage
{
    ...
    Objet ***tableauCarte;      //contient un tableau à trois dimension
    ObjetObjectif tableauObjectifs[NB_QUETE][NB_OBJECTIF_MAX+1];    //la première case servira à dire si toute la quête est finie
    int moment;
    //va contenir les coordonnées en pixels de chaque coin du rectangle du personnage
